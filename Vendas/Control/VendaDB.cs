...
namespace Vendas.Control
{
    public class VendaDB
    {
        ...
        public static bool SetInsereVenda(Venda venda, NpgsqlConnection conexao)
        {
            ...
            try
            {
                string vSql = "INSERT INTO PESSOA (HANDLE, CLIENTE, DATA, VALORLIQUIDO, NUMEROPEDIDO, VENDEDOR, OBSERVACAO, STATUS, STATUSDATA, LOGDATACADASTRO, LOGDATAALTERACAO, LOGUSUARIOCADASTRO, LOGUSUARIOALTERACAO) " +
